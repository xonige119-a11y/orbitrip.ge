...
import { Booking, Tour, Language, Driver } from '../types';
import { db } from './db';
...
export const emailService = {
     ...
     */
    sendBookingConfirmation: async (booking: Booking, tour: Tour | null, language: Language = Language.EN, driver: Driver | null = null): Promise<boolean> => {
        ...
        try {
            ...
            // Driver Phone Block
            const driverPhoneBlock = driver && driver.phoneNumber 
                ? `<div style="font-size: 14px; color: #059669; font-weight: bold; margin-top: 5px;">📞 <a href="tel:${driver.phoneNumber}" style="color: #059669; text-decoration: none;">${driver.phoneNumber}</a></div>`
                : '';
