      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12 md:mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
                ...
                <li><button onClick={() => onNavigate('DRIVER_REGISTRATION', '/drive-with-us')} className="hover:text-white transition-colors font-bold text-emerald-400">{isEn ? "Become a Driver" : "Стать Водителем"}</button></li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-slate-800 flex flex-col items-center justify-center gap-4 text-xs font-medium text-center">
            ...
            <div className="flex gap-6 items-center">
                ...
                <span className="text-emerald-400 font-bold bg-emerald-900/30 px-3 py-1 rounded-full border border-emerald-500/50 animate-pulse">v8.1 (USER)</span>
            </div>
        </div>
