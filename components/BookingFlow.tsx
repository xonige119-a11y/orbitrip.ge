                ...
                <div key={driver.id} className="bg-white border-2 border-slate-100 rounded-3xl p-6 hover:border-indigo-500 transition-all group relative">
                  <div className="flex flex-col sm:flex-row gap-6">
                    <div className="relative">
                      <img src={driver.photo} alt={driver.name} className="w-24 h-24 sm:w-32 sm:h-32 rounded-2xl object-cover shadow-lg" />
                    ...
                    <div className="flex-1 space-y-4">
                      <div className="flex flex-wrap items-start justify-between gap-2">
                        <div>
                          ...
                          <p className="text-slate-500 font-medium">{driver.car}</p>
                        </div>
                        <div className="text-right">
                          <div className="text-2xl font-extrabold text-indigo-900">₾ {driver.price}</div>
