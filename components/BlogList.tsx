...
const BlogList: React.FC<BlogListProps> = ({ language, onBookRoute }) => {
  ...
  return (
    <div className="bg-transparent min-h-screen font-sans">
      ...
      {/* SEO INJECTION */}
      <SEO 
        title={isEn ? "Travel Blog - Georgia Guide | OrbiTrip" : "Блог о путешествиях по Грузии | OrbiTrip"}
        description={isEn 
            ? "Discover Georgia with our travel guides. How to get to Batumi, what to see in Kazbegi, and secret local spots." 
            : "Откройте для себя Грузию с нашими гидами. Как добраться до Батуми, что посмотреть в Казбеги и секретные места."}
        keywords="Georgia travel blog, Tbilisi guide, Batumi transfer tips, Kazbegi route"
        type="article"
      />
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="lg:w-2/3">
            <div className="flex items-center justify-between mb-8">
                <h2 className="text-2xl font-black text-gray-900 border-l-4 border-indigo-600 pl-4 bg-white/50 backdrop-blur rounded-r-lg pr-4 py-1 inline-block">
            ...
            <div className="mt-12 text-center">
                <button className="inline-flex items-center text-gray-500 font-bold hover:text-indigo-600 transition border-b-2 border-transparent hover:border-indigo-600 pb-1 bg-white/50 px-4 py-2 rounded-lg">
