...
-- ORBITRIP DATABASE SCHEMA (v2.0 - Idempotent Fix)
...
-- FIX: Add flight_number if missing
DO $$ 
BEGIN 
...
-- FIX: Add missing columns to settings if they don't exist (Migration safe)
DO $$ 
BEGIN 
...
-- 7. FUNCTIONS (Required for DB Logic)
